...
docker kill cliCustomer cliProvider logspout || true
./network.sh down
...
cp "${DIR}/../test-network/organizations/peerOrganizations/org2.example.com/connection-org2.yaml" "${DIR}/organization/provider/gateway/"

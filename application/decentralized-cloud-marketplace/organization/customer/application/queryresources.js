...
async function main() {
    ...
    try {
        ...
        console.log('Use org.awesome.resource smart contract.');

        const contract = await network.getContract('awesomecontract', 'org.awesome.resource');
        ...
        // console.log('-----------------------------------------------------------------------------------------\n');
        // let queryResponse = await contract.evaluateTransaction('queryResourceHistory', userName, '00001');
        ...
        console.log('-----------------------------------------------------------------------------------------\n');
        let queryResponse2 = await contract.evaluateTransaction('queryResourcesByCreator', "AWS");
        ...
        // 3 partial key query
        // console.log(`3. Query Auction Partial Key.... Auctions in org.awesome.resource namespace and prefixed ${userName}`);
        // console.log('-----------------------------------------------------------------------------------------\n');
        // let queryResponse3 = await contract.evaluateTransaction('queryResourcePartial', userName);
        ...
        // console.log('-----------------------------------------------------------------------------------------\n');
        // let queryResponse4 = await contract.evaluateTransaction('queryResourceNamed', 'redeemed');
        ...
        // console.log('-----------------------------------------------------------------------------------------\n');
        // let queryResponse5 = await contract.evaluateTransaction('queryResourceNamed', 'value');

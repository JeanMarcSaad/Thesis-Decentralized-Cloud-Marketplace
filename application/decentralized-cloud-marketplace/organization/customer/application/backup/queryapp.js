...
async function main() {
    ...
    try {
        ...
        console.log('-----------------------------------------------------------------------------------------\n');
        let queryResponse = await contract.evaluateTransaction('queryHistory', 'customer_1', '00001');
        ...
        // 2 ownership query
        console.log('2. Query Auction Ownership.... Auctions owned by Customer \'customer_1\'');
        console.log('-----------------------------------------------------------------------------------------\n');
        let queryResponse2 = await contract.evaluateTransaction('queryOwner', 'customer_1');
        ...
        // 3 partial key query
        console.log('3. Query Auction Partial Key.... Auctions in org.awesome.auction namespace and prefixed customer_1');
        console.log('-----------------------------------------------------------------------------------------\n');
        let queryResponse3 = await contract.evaluateTransaction('queryPartial', 'customer_1');
